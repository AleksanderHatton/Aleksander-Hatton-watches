...
export default function App() {
  ...
  useEffect(() => {
    fetchStock();
  }, [currentView]); // Re-fetch on view shifting
                ...
                <div className="bg-zinc-50 border border-zinc-100 p-6 sm:p-8 space-y-6 shadow-sm">
                  ...
                  {!contactSuccess ? (
                    <form onSubmit={handleContactSubmit} className="space-y-4 text-xs">
                      <div>
                        <label className="block text-[10px] font-mono uppercase tracking-wider text-zinc-500 mb-1.2 font-semibold">Your Name *</label>
                        <input 
                          type="text" 
                          required
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] font-mono uppercase tracking-wider text-zinc-500 mb-1.2 font-semibold">Email *</label>
                          <input 
                            type="email" 
                            required
                        ...
                        <div>
                          <label className="block text-[10px] font-mono uppercase tracking-wider text-zinc-500 mb-1.2 font-semibold">Phone (optional)</label>
                          <input 
                            type="tel" 
                      ...
                      <div>
                        <label className="block text-[10px] font-mono uppercase tracking-wider text-zinc-500 mb-1.2 font-semibold">Your Message *</label>
                        <textarea 
                          rows={5}
                          required
                    ...
                    <div className="text-center py-8 space-y-4">
                      ...
                      <p className="text-xs text-zinc-650 max-w-sm mx-auto leading-relaxed">
                        We have logged your communications on our admin desk and dispatched auto-confirmation details to your designated inbox.
                      </p>
                      <button
